      ...
      <b-row>
        <b-col cols="12">
          <b-card header-tag="header" footer-tag="footer">
            <!-- ヘッダー -->
            <div slot="header">
              <i class="fa fa-align-justify"></i> <strong>ロット管理 | 編集</strong>
            </div>
            <!-- /ヘッダー -->
            <!-- パン屑 -->
            ...
            <b-form-group>
              ...
              <b-form-input type="text" id="name" placeholder="ロット名" v-model="lot.name"
            ...
            <b-form-group>
              ...
              <b-form-input type="text" id="lot_number" placeholder="ロットナンバー" v-model="lot.lot_number"
            ...
            <b-form-group>
              ...
              <b-form-input type="text" id="jan_code" placeholder="JANコード" v-model="lot.jan_code"
            ...
            <b-form-group>
              ...
              <b-form-checkbox
                      ...
                      v-model="lot.is_ten_days_notation"
                      value="1"
                      unchecked-value="0"
            ...
            <b-form-group>
              ...
              <b-form-select id="location_id" :options="getLocationOptions" v-model="lot.location_id"
            ...
            <b-form-group>
              ...
              <b-form-select id="brand_id" :options="getBrandOptions" v-model="lot.brand_id"
...
<script>
  ...
  export default {
    ...
    async asyncData({ store, route }) {
      if (store.getters['lots/lots'].find(data => data.id === route.params.id)) {
        return
      }
    ...
    computed: {
       ...
       */
      lot() {
        return cloneDeep(this.lots.find(data => data.id == this.$route.params.id));
      },
      /**
       * セレクトボックス用の拠点一覧を取得
       *
    ...
    methods: {
      ...
      async setOrderedAtDate(date) {
        this.lot.ordered_at = moment(date).format('YYYY-MM-DD');
      },
      async setExpirationDate(date) {
        this.lot.expiration_date = moment(date).format('YYYY-MM-DD');
      },
      ...mapActions('lots', ['updateLot'])
    },
  }
</script>
