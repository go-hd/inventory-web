      ...
      <b-row>
        <b-col cols="12">
          <b-card header-tag="header" footer-tag="footer">
            <!-- ヘッダー -->
            <div slot="header">
              <i class="fa fa-align-justify"></i> <strong>ブランド管理 | 新規登録</strong>
            </div>
            <!-- /ヘッダー -->
            <!-- パン屑 -->
            ...
            <div class="form-actions float-right">
              <b-button type="submit" variant="primary" @click="onClickCreateBrand()">登録する</b-button>
